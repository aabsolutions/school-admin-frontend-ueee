...
export class MisFotosTeacherService {
  constructor(private http: HttpClient) {}

  getMe(): Observable<ProfilePhotos> {
    return this.http
      .get<{ data: ProfilePhotos }>(`${environment.apiUrl}/teachers/me`)
      .pipe(map((r) => r.data));
  }
  ...
  uploadPhoto(
    ...
    return this.http
      .post<{ data: ProfilePhotos }>(`${environment.apiUrl}/teachers/${teacherId}/photo`, fd)
      .pipe(map((r) => r.data));
  }
}
